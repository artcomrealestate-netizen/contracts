              ...
              data: (allCustomers) {
                final customers = allCustomers.where((c) {
                  ...
                  return c.displayName.toLowerCase().contains(query) ||
                      (c.contact.phone?.toLowerCase().contains(query) ?? false) ||
                      (c.contact.email?.toLowerCase().contains(query) ?? false);
                }).toList();

                if (customers.isEmpty) {
                  return Center(child: Text(allCustomers.isEmpty ? 'No customers yet.' : 'No matches.'));
                }
